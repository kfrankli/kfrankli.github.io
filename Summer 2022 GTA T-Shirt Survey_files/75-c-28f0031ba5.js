...
const r=o[1]
Promise.all([n.e(6),n.e(25),n.e(47),n.e(126),n.e(4135)]).then(n.bind(null,"xTOM")).then(e=>{e.showFilePreview(r,i)}).catch(e=>{s.a.flashError(y.t("Something went wrong loading the file previewer."))})}})}function B(){let e
s.a.subscribe("userContent/change",()=>{clearTimeout(e)
e=setTimeout(O,50)})
s()(document).bind("user_content_change",O)}function F(){s()(()=>{setInterval(O,15e3)
setTimeout(O,15)})}function P(){s()(".show_sub_messages_link").click((function(e){e.preventDefault()
...
s()(this).parents(".communication_sub_message").remove()}))}function M(){s()(".communication_message .add_entry_link").click((function(e){e.preventDefault()
...
i.addClass("external").children("span.ui-icon-extlink").remove().end().html("<span>"+n.html()+"</span>").attr("target","_blank").attr("rel","noreferrer noopener").append(t)}}}),100)}function X(){[C,A,j,R,q,z,L,D,H,B,F,P,M,V,W,U,$,J,K,G,Y,Q].map(i["a"]).map(e=>e())}},"/oRJ":function(e,t,n){"use strict"
...
this.loadRCE(e=>{e.renderIntoDiv(a,o,e=>{e.tinymceOn("init",()=>n(i,p.wrapEditor(e)))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){return Promise.all([n.e(6),n.e(7),n.e(8),n.e(10),n.e(11),n.e(12),n.e(15),n.e(17),n.e(19),n.e(20),n.e(23),n.e(28),n.e(41),n.e(3746)]).then(n.bind(null,"j/Fk")).then(e=>{this.RCE=e
Object(h["a"])()
...
//# sourceMappingURL=75-c-28f0031ba5.js.map